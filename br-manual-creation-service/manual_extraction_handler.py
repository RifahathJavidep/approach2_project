"""
Manual Service — business logic for manual BR requirement_engine.
"""
import logging
import os
import shutil
...
from common.java_client import store_requirements
from common.requirement_mapper import to_payload

logger = logging.getLogger("prism.manual.services.requirement_engine")
