...
def manual_extract_task(self, project_id: str, document_url: str, description: str, page_no: int):
    ...
    try:
        result = asyncio.get_event_loop().run_until_complete(
            run_manual_dspy_extraction(project_id, document_url, description, page_no)
        )
        return result
