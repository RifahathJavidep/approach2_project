...
Example:
    from requirement_engine.file_router import FileRouter, FileType
...
class FileType(Enum):
    """Supported document types for the requirement extraction pipeline."""
    PDF = "pdf"
...
class FileRouter:
    ...
    # Document types — processed for text + embedded image requirement_engine
    PDF_EXTENSIONS = {".pdf"}
    ...
    def _is_scanned_pdf(cls, file_path: str) -> bool:
        ...
        Opens the PDF and attempts text requirement_engine. If the total extracted
