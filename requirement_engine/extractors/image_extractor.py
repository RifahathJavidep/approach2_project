...
inside documents. Delegates to the OCR extractor for text requirement_engine.

Example:
    from requirement_engine.extractors import StandaloneImageExtractor
    ...
    def __init__(self, ocr_extractor=None):
        ...
        Args:
            ocr_extractor: LocalOCRExtractor instance. Required for
                           text requirement_engine to work.
        """
