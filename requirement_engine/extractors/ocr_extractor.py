...
Provides local OCR text requirement_engine from images using PaddleOCR.
...
Example:
    from requirement_engine.extractors import LocalOCRExtractor
...
class LocalOCRExtractor:
    """
    Local OCR requirement_engine using PaddleOCR.
    ...
    def extract_text_from_image(self, image_path: str) -> Dict[str, Any]:
        ...
        Returns:
            Dictionary containing:
                ...
                - success: Whether requirement_engine succeeded
        """
        try:
