...
def main():
    ...
    import dspy
    from requirement_engine.pipeline import _get_lm
    ...
    from requirement_engine.generators.trained_extractor import TrainedExtractor
    from requirement_engine.generators.training import train_extractor
