"""
TestGen Service — Celery bootstrap.
Start worker: celery -A celery_app worker --loglevel=info -Q testcase_engine
"""
import os
import sys
import ssl
...
app = Celery("testgen", broker=broker_url, backend=result_backend)
...
app.conf.imports = ("testcase_generation_task",)
